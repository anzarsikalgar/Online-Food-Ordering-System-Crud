...
def create_connection():
    try:
        conn = mysql.connector.connect(
            ...
            database='Online_Food_Ordering_SystemMan'
        )
        return conn
    except Error as e:
...
def setup_database():
    try: 
        ...
        cursor.execute("CREATE DATABASE IF NOT EXISTS Online_Food_Ordering_SystemMan")
        print("Database 'Online_Food_Ordering_SystemMan' created successfully!")

        # Switch to the database
        cursor.execute("USE Online_Food_Ordering_SystemMan")
